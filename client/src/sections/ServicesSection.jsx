...
import { FaPrint, FaRocket, FaCog, FaDraftingCompass, FaBook, FaBoxOpen } from 'react-icons/fa';
    ...
    <section id="services" className="services-section">
      <div className="section-header">
        ...
        <p className="section-subtitle">
          Whether you need a single custom part or a complete product launch strategy, Knemco
          provides comprehensive manufacturing and consulting services tailored to your needs.
        </p>
      </div>
